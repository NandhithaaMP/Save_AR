...
class TransactionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Transactions",style: TextStyle(fontFamily: "poppinsSemi",fontSize: 15,fontWeight: FontWeight.w500),),
        centerTitle: true,
                            ...
                            children: [
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                 ...
                                 //       image: AssetImage("assests/vectorimage3.png"),
                                 //       fit: BoxFit.cover,
                                 ...
                                 // )
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(20),
                                      image: DecorationImage(
                                          image: AssetImage("assests/vectorImage2-.png"),fit:  BoxFit. fill,
                                          colorFilter: ColorFilter.mode(ctorange.withOpacity(1), BlendMode.multiply)
                                      ),
                                      color: ctorange,
                                    ),
                                    child: Center(child: Text("Receipt",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 11,fontFamily: "pippinsRegular"),)),
                                  ),
